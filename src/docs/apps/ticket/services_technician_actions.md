...
- `build_action_keyboard` + callback helpers: renders inline button markup and callback payload parsing/encoding for bot handlers.
...
- Queue listing intentionally focuses on active technician statuses (`assigned`, `rework`, `in_progress`).
