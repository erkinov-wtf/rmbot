...
class RulesConfigVersion(AppendOnlyModel):
    ...
    action = models.CharField(max_length=20, choices=RulesConfigAction.choices, db_index=True)
    ...
    source_version = models.ForeignKey("self", on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
...
class RulesConfigState(TimestampedModel):
    ...
    active_version = models.ForeignKey(RulesConfigVersion, on_delete=models.PROTECT, related_name="+")
