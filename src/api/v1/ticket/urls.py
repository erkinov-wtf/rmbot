...
urlpatterns = [
    ...
    path("<int:pk>/transitions/", TicketTransitionListAPIView.as_view(), name="ticket-transitions"),
    path("<int:pk>/start/", TicketStartAPIView.as_view(), name="ticket-start"),
    path("<int:pk>/to-waiting-qc/", TicketToWaitingQCAPIView.as_view(), name="ticket-to-waiting-qc"),
    ...
    path("<int:pk>/work-session/start/", TicketWorkSessionStartAPIView.as_view(), name="ticket-work-session-start"),
    path("<int:pk>/work-session/pause/", TicketWorkSessionPauseAPIView.as_view(), name="ticket-work-session-pause"),
    path("<int:pk>/work-session/resume/", TicketWorkSessionResumeAPIView.as_view(), name="ticket-work-session-resume"),
    path("<int:pk>/work-session/stop/", TicketWorkSessionStopAPIView.as_view(), name="ticket-work-session-stop"),
]
