...
const RU_MESSAGES: TranslationCatalog = {
  ...
  "Last {{days}} days": "Последние {{days}} дней",
  Login: "Вход",
  Logout: "Выйти",
  ...
  "QC fail comment (optional)": "Комментарий QC fail (необязательно)",
  "QC Pass": "QC пройден",
  ...
  "Ticket Base XP": "Базовый XP за тикет",
...
const UZ_MESSAGES: TranslationCatalog = {
  ...
  "Last {{days}} days": "So'nggi {{days}} kun",
  Login: "Kirish",
  Logout: "Chiqish",
  "Manual Adjustment": "Qo'lda tuzatish",
  ...
  "QC fail comment (optional)": "QC fail izohi (ixtiyoriy)",
  ...
  "Ticket Base XP": "Ariza uchun bazaviy XP",
  ...
  Previous: "Oldingi",
  Next: "Keyingi",
  "Rows per page": "Sahifadagi qatorlar",
  "Showing {{from}}-{{to}} of {{total}}":
